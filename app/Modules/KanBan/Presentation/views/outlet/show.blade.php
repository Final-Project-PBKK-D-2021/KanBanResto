...
<div class="card">
  <div class="card-body">
    ...
    <a href="{{route('outlet.edit', ['outlet' => $outlet->id])}}" class="btn btn-primary">Edit</a>
    <form action="{{route('outlet.destroy', ['outlet' => $outlet->id])}}" method="post" class="d-inline">
        @method('delete')
        @csrf
        <button type="submit" class="btn btn-danger">Delete</button>
    </form>
    <a href="{{route('outlet.index')}}" class="card-link">Back</a>
  </div>
</div>
@endsection